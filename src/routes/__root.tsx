...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Marriage Acquisition Summit 2026 — Dossier riservato del Board." },
      { name: "theme-color", content: "#0a1226" },
      { property: "og:title", content: "MAS 2026 — Berlin Edition" },
      { property: "og:description", content: "Dossier riservato. Accesso esclusivo al Board." },
